...
const BsAdpAttendance = () => {
  ...
  return (
    <div>
      <motion.h1 initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-4 font-display text-xl font-bold text-foreground sm:text-2xl">BS / ADP Attendance</motion.h1>
...
export default BsAdpAttendance;
